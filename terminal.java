...
public class terminal {
        public static void main(String[] args) {
                ...
                // List<String> words1 = Arrays.asList("hello", "world", "a", "b", "dfsd",
                // "rg");
                ...
                // 7. reduce(U identity, BiFunction<U, ? super T, U>
                // accumulator,BinaryOperator<U> combiner)
                // List<String> words6 = Arrays.asList("hello", "world", "");
                // Integer totalLength = words6.stream().reduce(0, (length, word) -> length +
                ...
                // 8. collect(Supplier<R> supplier, BiConsumer<R, ? super T> accumulator,
                // BiConsumer<R, R> combiner)
                // List<String> words7 = Arrays.asList("hello", "world","");
                // ArrayList<String> ans = words7.stream().collect(ArrayList::new,
                ...
                // // words9.stream().min(Comparator.comparing(String::length));
